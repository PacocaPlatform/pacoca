...
(function () {
  ...
  var DICT = {
    "pt-BR": {
      ...
      "settings.size.hint": "Cada coluna vale 3m e cada linha 1,5m. Precisa de outro tamanho? Use as opções avançadas.",
      "settings.advanced": "Avançado",
      "settings.scale.hint": "Os valores padrão de escala (3.0 / 1.5) casam com a física do jogo. Mude só se souber o efeito.",
      ...
      "metrics.li2": "<strong>Grade Y (altura)</strong>: cada linha mede <strong>1,5m</strong> (<code>ystep: 1.5</code>).",
    ...
    "en-US": {
      ...
      "settings.size.hint": "Each column is 3m and each row 1.5m. Need another size? Use the advanced options.",
      "settings.advanced": "Advanced",
      "settings.scale.hint": "The default scale (3.0 / 1.5) matches the game physics. Change only if you know the effect.",
      ...
      "metrics.li2": "<strong>Grid Y (height)</strong>: each row is <strong>1.5m</strong> (<code>ystep: 1.5</code>).",
