...
(function () {
  ...
  var DICT = {
    "pt-BR": {
      ...
      "settings.size.hint": "Cada coluna vale 3m e cada linha 2m. Precisa de outro tamanho? Use as opções avançadas.",
      "settings.advanced": "Avançado",
      "settings.scale.hint": "Os valores padrão de escala (3.0 / 2.0) casam com a física do jogo. Mude só se souber o efeito.",
      ...
      "el.moving-platform.short": "Móvel",
      "el.moving-platform.name": "Plataforma Móvel",
      "el.moving-platform.desc": "Plataforma que se move lateralmente ou verticalmente",
      "moving_platform_modal.title": "Configurar Plataforma Móvel",
      "moving_platform_modal.direction": "Direção do Movimento",
      "moving_platform_modal.horizontal": "Lateral / Horizontal",
      "moving_platform_modal.vertical": "Vertical",
      "moving_platform_modal.range": "Distância (metros)",
      "moving_platform_modal.speed": "Velocidade (m/s)",
      "moving_platform_modal.apply": "Aplicar",
      "moving_platform_modal.initial_direction": "Direção Inicial",
      "moving_platform_modal.initial_direction_left": "Esquerda",
      "moving_platform_modal.initial_direction_right": "Direita",
      "moving_platform_modal.initial_direction_up": "Cima",
      "moving_platform_modal.initial_direction_down": "Baixo",
      "moving_platform_modal.invert_on_collision": "Inverter direção ao colidir",
      "moving_platform_modal.vertical_rule": "Regra de Movimento Vertical",
      "moving_platform_modal.vertical_rule_default": "Padrão (inverte em colisão)",
      "moving_platform_modal.vertical_rule_range": "Faixa de movimento (oscilação por distância)",
      "toast.mplatConfigured": "Plataforma móvel configurada!",
      ...
      "metrics.li1": "<strong>Grade X (largura)</strong>: cada bloco <code>#</code> ou rampa <code>/</code> mede <strong>3m</strong>.",
      "metrics.li2": "<strong>Grade Y (altura)</strong>: cada linha mede <strong>2m</strong> (<code>ystep: 2.0</code>).",
    ...
    "en-US": {
      ...
      "settings.size.hint": "Each column is 3m and each row 2m. Need another size? Use the advanced options.",
      "settings.advanced": "Advanced",
      "settings.scale.hint": "The default scale (3.0 / 2.0) matches the game physics. Change only if you know the effect.",
      ...
      "el.moving-platform.short": "Moving",
      "el.moving-platform.name": "Moving Platform",
      "el.moving-platform.desc": "Platform that moves horizontally or vertically",
      "moving_platform_modal.title": "Configure Moving Platform",
      "moving_platform_modal.direction": "Movement Direction",
      "moving_platform_modal.horizontal": "Horizontal",
      "moving_platform_modal.vertical": "Vertical",
      "moving_platform_modal.range": "Distance (meters)",
      "moving_platform_modal.speed": "Speed (m/s)",
      "moving_platform_modal.apply": "Apply",
      "moving_platform_modal.initial_direction": "Initial Direction",
      "moving_platform_modal.initial_direction_left": "Left",
      "moving_platform_modal.initial_direction_right": "Right",
      "moving_platform_modal.initial_direction_up": "Up",
      "moving_platform_modal.initial_direction_down": "Down",
      "moving_platform_modal.invert_on_collision": "Invert direction on collision",
      "moving_platform_modal.vertical_rule": "Vertical Movement Rule",
      "moving_platform_modal.vertical_rule_default": "Default (invert on collision)",
      "moving_platform_modal.vertical_rule_range": "Movement range (oscillate by distance)",
      "toast.mplatConfigured": "Moving platform configured!",
      ...
      "metrics.li1": "<strong>Grid X (width)</strong>: each block <code>#</code> or ramp <code>/</code> is <strong>3m</strong>.",
      "metrics.li2": "<strong>Grid Y (height)</strong>: each row is <strong>2m</strong> (<code>ystep: 2.0</code>).",
